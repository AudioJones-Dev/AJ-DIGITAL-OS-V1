...
- Root and path-scoped `AGENTS.md` instructions.
...
1. Read applicable `AGENTS.md` files before inspection.
...
- Candidate totals by confidence.
- Proposed scope for `prune-reachability`.
- Commands run and results.
- Explicit statement that no code modifications were made.
