...
- `connectors/` - L3 connector layer: typed connector contract, file-backed registry, guarded executor, attribution, and per-provider adapters (including disabled-by-default Social Ops stubs).
