...
| Approval inbox | Platform admin, tenant admin | Required | Loading, empty, error, permission, partial success, agent active | Approval-gated actions | UI built · backend pending ([status](APPROVAL_INBOX_BUILD_STATUS.md)) |
