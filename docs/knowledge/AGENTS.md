...
- `index.md` catalogs maintained wiki pages, source summaries, and outputs.
- `log.md` records substrate maintenance, ingests, queries, lint passes, and major updates.
- `raw/` holds source material placeholders and future source files; agents must not rewrite source material.
- `wiki/` holds future maintained wiki pages.
- `outputs/` holds future generated briefs, reports, plans, and other derived artifacts.
- `assets/` holds future local attachments referenced by sources or wiki pages.
