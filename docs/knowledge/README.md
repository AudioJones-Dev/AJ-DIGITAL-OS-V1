...
This README defines the operating pattern only. It does not create a full Obsidian vault, ingest sources, update runtime retrieval, install plugins, or enable autonomous editing.

## Open Questions

- Should the first concrete vault live inside this repo, in an Obsidian vault, or in a separate `AJ-DIGITAL-KNOWLEDGE` repo?
