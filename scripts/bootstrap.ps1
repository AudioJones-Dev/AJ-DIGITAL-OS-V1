...
$dirs = @(
  ...
  "C:\dev\infra\monitoring\alerts",
  "C:\dev\infra\monitoring\grafana",
  "C:\dev\infra\monitoring\grafana\dashboards",
  "C:\dev\infra\monitoring\grafana\provisioning",
  "C:\dev\infra\monitoring\grafana\provisioning\dashboards",
  "C:\dev\infra\monitoring\grafana\provisioning\datasources",
  "C:\dev\infra\n8n",
  "C:\dev\infra\n8n\workflows",
  "C:\dev\infra\docs",
  "F:\CACHE\docker",
